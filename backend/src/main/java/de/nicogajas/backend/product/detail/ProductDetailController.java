...
public class ProductDetailController {
    ...
    @Autowired
    public ProductDetailController(Products products){this.products = products;}
    ...
    public record GetProductDetailResponse(
        ...
        public static GetProductDetailResponse fromProduct(Product product){
            return new GetProductDetailResponse(product.id(), product.name(), product.price(), product.shortDescription(), product.description(), ProductCatalogController.ProductImageResponse.fromProductImage(product.image()));
        }
    }
